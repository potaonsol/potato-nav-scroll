const PotatoSection = () => {
  return <section id="pota-section" className="min-h-screen w-full bg-potato-beige flex items-center justify-center py-20">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <img src="/lovable-uploads/8b433ac7-8307-4fad-a518-575db7291bdc.png" alt="I AM $POTA" className="h-72 md:h-96 lg:h-[30rem] w-auto object-contain" />
          </div>
          <p className="text-2xl md:text-4xl mb-8 leading-relaxed font-comic font-semibold text-yellow-900">
          ...
          <div className="overflow-hidden max-w-6xl mx-auto">
            ...
            <div className="flex gap-12 mb-12 animate-slide-left">
              ...
              src: "/lovable-uploads/45b09e0f-7347-4b14-98c7-bef86119c3fd.png",
              alt: "Flat Potato"
            }, {
              src: "/lovable-uploads/56f1331d-f65c-430c-9634-d9eed098ffc7.png",
              alt: "Hat Potato"
            }, {
              src: "/lovable-uploads/810a5cb0-5144-4c62-b9ac-a71247a7c15e.png",
              alt: "Glasses Potato"
            }, {
              ...
              src: "/lovable-uploads/1b1cc06f-f17a-4ea1-8790-22ba74a27e2b.png",
              alt: "Potato Tarot"
            }].map((potato, index) => <div key={index} className="flex-shrink-0">
                  <div className="bg-potato-beige p-6 rounded-2xl border-2 border-potato-brown/20 shadow-lg transition-transform duration-300 hover:scale-110">
                    <img src={potato.src} alt={potato.alt} className="h-48 md:h-64 w-48 md:w-64 object-contain" />
                  </div>
                </div>)}
            </div>
